...
- **Прибыль/убыток** — финансовые результаты, включая прогресс баланса
...
### 3. Выберите файлы и настройки:

- Программа покажет найденные XLSX-файлы из папки trades/
- Выберите нужные (можно несколько через запятую)
- Выберите фильтр: только OTC, только не-OTC или всё вместе
- Введите текущий баланс (нужен для точного расчёта прогресса баланса)
...
- Размер и цвета графиков
- Процент окна для скользящего винрейта
- Количество отображаемых топ-активов
- Максимум файлов в списке выбора
