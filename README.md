...
- **Прогресс по дням** — отслеживайте, как улучшаются Ваши результаты
...
1. Зайдите на Pocket Option: https://pocketoption.com/en/cabinet/trading-history
...
Выберите файлы (например: 1 или 1, 2, 3): 1, 2
```
...
3. **Следите за прогрессом** — линия должна расти (графики 1, 6)
...
3. Не игнорируйте серии лоссов (>5 — опасно!)
...
A: Убедитесь, что файлы в формате `.xlsx` и лежат в папке `trades/` или рядом со скриптом.
...
A: Да! Выберите несколько файлов через запятую: `1, 2, 3`

**Q: Как сохранить графики?**  
A: Нажмите на иконку дискеты в окне графиков (левый верхний угол).
